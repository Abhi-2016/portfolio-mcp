...
Working through these in order, starting with #1:
1. Concept taxonomy — fixed vocabulary vs. extracted from existing text (**next up**)
2. `get_key_decisions` uneven coverage across the 5 source projects
3. No freshness/versioning field in the schema
4. No fuzzy-matching for project name lookups
